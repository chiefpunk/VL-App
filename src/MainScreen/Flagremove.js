...
class FlagremoveScreen extends React.Component {
                        ...
                        <View style={{ position: "absolute", backgroundColor: "rgba(255,255,255,0.5)", width: "90%", height: "70%", marginTop: 150, marginLeft: 20 }}>
                            ...
                            <View style={{ padding: 10, width: "60%" }}>
                                ...
                                <View style={{ width: "80%", alignItems: "center", flexDirection: "row", paddingTop: 60 }}>
                                    <Button style={{ marginBottom: 10, marginRight: 20, width: "100%", borderRadius: 10, backgroundColor: "rgb(222,108,39)", textAlign: "center", alignItems: "center", justifyContent: "center" }}><Text style={{ fontSize: 22 }}>REMOVER</Text></Button>
...
export default FlagremoveScreen;