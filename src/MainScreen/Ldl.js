...
class LdlScreen extends React.Component {
                    ...
                    <Content>
                        ...
                        <View style={{padding:10,width:"60%"}}>
                            ...
                            <View style={{ padding: 10, width: "60%" }}>
                                <Text>PK Fim:</Text>
                                <Item regular style={{ marginTop: 15 }}>
                                    <Input placeholder='1062+500' placeholderTextColor='white' style={{ height: 40, backgroundColor: "rgb(55,119,192)", color: "white" }} />
                                </Item>
                                
                            </View>
                            <View style={{ padding: 10, width: "60%" }}>
                                <Text>Velocidade Temporária:</Text>
                                <Item regular style={{ marginTop: 15 }}>
                                    <Input placeholder='25' placeholderTextColor='white' style={{ height: 40, backgroundColor: "rgb(55,119,192)", color: "white" }} />
                                </Item>
                                <View style={{ width: "80%", alignItems: "center", flexDirection: "row", paddingTop: 60 }}>
                                    <Button style={{ marginBottom: 10, marginRight: 20, width: "100%", borderRadius: 10, backgroundColor: "rgb(222,108,39)", textAlign: "center", alignItems: "center", justifyContent: "center" }}><Text style={{ fontSize: 21 }}>ADICIONAR</Text></Button>
                                    <Button style={{ marginBottom: 10, marginRight: 20, width: "100%", borderRadius: 10, backgroundColor: "rgb(222,108,39)", textAlign: "center", alignItems: "center", justifyContent: "center" }}><Text style={{ fontSize: 21 }}>CANCELAR</Text></Button>
                                </View>
                            </View>
                        </View>
